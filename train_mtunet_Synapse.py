...
parser.add_argument("--list_dir", default="/newdata/why/Synapse/lists_Synapse")
parser.add_argument("--root_dir", default="/newdata/why/Synapse/")
parser.add_argument("--volume_path", default="/newdata/why/Synapse/test")
