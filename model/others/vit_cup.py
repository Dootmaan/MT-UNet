...
'''
   This file includes several classes: attention,mlp,transformer block, embedding,encoder,decoder,F-unet block
'''
import torch
...
class _Mlp(nn.Module):
    def __init__(self):
        ...
        self.fc1 = Linear(225, 225*4)
        self.fc2 = Linear(225*4, 225)
        self.act_fn = ACT2FN["gelu"]
